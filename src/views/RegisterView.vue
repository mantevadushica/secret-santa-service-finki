    ...
    <section class="card auth-card"> 
      ...
      <form @submit.prevent="register"> 
        ...
        <button 
          ...
          :disabled="loading"
        >
          {{ loading ? 'Се креира...' : 'Регистрирај се' }}
        </button> 
      </form> 

      <p>
        Веќе имате профил? 
        <RouterLink to="/login">Најава</RouterLink>
      </p> 
    </section> 
  </main> 
</template> 
...
async function register() { 
  ...
  try { 
    ...
    error.value = e.code === 'auth/email-already-in-use'
      ...
      : 'Регистрацијата не успеа. Проверете ги податоците.' 
  } finally { 
    loading.value = false 
  } 
} 
